...
const features = [
  "سهل الاستخدام بدون منحنى تعليمي حاد",
  "تصميم عربي متكامل من البداية",
  "أداء سريع وموثوق على جميع الأجهزة",
  "دعم فني شامل وتحديثات منتظمة",
]
...
export function DeveloperExperience() {
  ...
  const fullText = `→ تشغيل X-WorkFlow
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <h2 className="mt-2 font-mono text-3xl font-bold tracking-tight sm:text-4xl text-balance">
              مصمم ليناسب احتياجات المصممين
            </h2>
            <p className="mt-4 text-lg text-muted-foreground">
              X-WorkFlow مصمم بسهولة وكفاءة عالية لتناسب احتياجاتك اليومية وتطورات عملك المستمرة.
            </p>
